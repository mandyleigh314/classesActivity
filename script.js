...
class Factory {
  ...
  static customerBuild(color, car, options) {
...
let mazda3 = new Car('mazda3', 3, 'red', 'hybrid', 'automatic', 'touring', 'base', 'premium', 'leather', true)
...
Factory.customerBuild('black', miataRf, [
  'hid headlights',
  ' sports suspension',
...
Factory.customerBuild('red', trailBlazer, ['seat warmers', ' tinted windows', 'fog lamps'])
